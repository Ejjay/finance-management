...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'create_annual_plan') {
    $fiscalYear = $_POST['fiscal_year'];
    $totalBudget = $_POST['total_budget'];
    $budgetPlanning->createAnnualBudgetPlan($fiscalYear, $totalBudget);
}
?>
...
<head>
    ...
    <title>Annual Budget Planning</title>
...
<body>
    ...
    <div class="main-content">
        <h2 class="mb-4">Annual Budget Planning</h2>

        <div class="card mb-4">
            <div class="card-header">
                <h4>Create Annual Budget Plan</h4>
            </div>
            <div class="card-body">
                <form method="POST">
                    <input type="hidden" name="action" value="create_annual_plan">
                    <div class="mb-3">
                        <label for="fiscal_year" class="form-label">Fiscal Year</label>
                        <input type="number" class="form-control" id="fiscal_year" name="fiscal_year" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <button type="submit" class="btn btn-primary">Create Annual Plan</button>
                </form>
            </div>
        </div>
    </div>
